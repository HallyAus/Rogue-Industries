        ...
        <div className="grid gap-12 md:grid-cols-4">
          ...
          <div className="md:col-span-1">
            ...
            <div className="mt-6 flex gap-1">
              <SocialIcon platform="instagram" href={SITE_CONFIG.social.instagram} />
              <SocialIcon platform="facebook" href={SITE_CONFIG.social.facebook} />
              <SocialIcon platform="youtube" href={SITE_CONFIG.social.youtube} />
            </div>
          </div>
